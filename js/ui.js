...
function initPanelHeaders() {
    ...
    mountPanelHeader('panel-header-tasks-item-edit', createPanelHeader('Edytuj zadanie', {
        titleId: 'tasks-edit-panel-title',
        onClose: closeTodoItemEditor
    }));
    mountPanelHeader('panel-header-tasks-list-picker', createPanelHeader('Dodaj do listy', { onClose: closeTasksListPicker }));
