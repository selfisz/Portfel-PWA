const CACHE_NAME = 'finanse-pwa-v368';
...
const ASSETS = [
  ...
  'js/skryba-chat-ui.js',
  'js/skryba-threads.js',
  'js/skryba-router.js',
  'js/skryba-voice.js',
  'js/assistant.js',
  ...
  'js/reports-day-month-summary.js',
  'js/reports-analysis-cache.js',
  'js/reports-analysis.js',
  'js/month-close-duplicates-ui.js',
  'js/month-close.js',
  'icons/icon-192.png',
  'icons/icon-512.png',
